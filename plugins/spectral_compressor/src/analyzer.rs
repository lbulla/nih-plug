...
pub struct AnalyzerData {
    ...
    pub envelope_followers: Box<[f32]>,
    ...
    pub gain_difference_db: Box<[f32]>,
...
impl Default for AnalyzerData {
    fn default() -> Self {
        Self {
            ...
            num_bins: 0,
            envelope_followers: [0.0; crate::MAX_WINDOW_SIZE / 2 + 1].into(),
            gain_difference_db: [0.0; crate::MAX_WINDOW_SIZE / 2 + 1].into(),
        }
    }
}
